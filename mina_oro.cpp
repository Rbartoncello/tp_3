...
Mina_oro::Mina_oro(string nombre) : Edificacion (nombre){
    this->emoji = EMOJI_MINA_ORO;
...
void Mina_oro::hablar_sobre_mi(){
    cout << "SOY UN " + devolverNombre() +  " ( "  + devolver_emoji() + " ) Y ME ENCUENTRO EN EL CASILLERO CONSULTADO" << endl;
}
