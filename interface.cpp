...
void imprimir_menu_principal(){
    ...
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
    cout << "\t\t\t\t\t║ " << EMOJI_CUATRO << " ║" << END_COLOR << TXT_BOLD <<" Comenzar partida " << EMOJI_BRUJULA << TXT_LIGHT_AQUA_43 << "                   ║" << endl;
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
...
void imprimir_menu_juego(){
    ...
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
    cout << "\t\t\t\t\t║ " << EMOJI_CUATRO << " ║" << END_COLOR << TXT_BOLD <<" Atacar un edificio por coordenada " << EMOJI_MAPA  << TXT_LIGHT_AQUA_43 << "   ║" << endl;
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
    cout << "\t\t\t\t\t║ " << EMOJI_CINCO << " ║" << END_COLOR << TXT_BOLD <<" Reparar un edificio por coordenada " << EMOJI_BRUJULA << TXT_LIGHT_AQUA_43 << " ║" << endl;
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
    cout << "\t\t\t\t\t║ " << EMOJI_SEIS << " ║" << END_COLOR << TXT_BOLD <<" Comprar bombas " << EMOJI_INVENTARIO << TXT_LIGHT_AQUA_43 << "                     ║" << endl;
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
    cout << "\t\t\t\t\t║ " << EMOJI_SIETE << " ║" << END_COLOR << TXT_BOLD <<" Consultar coordenada " << EMOJI_BUSQUEDA << TXT_LIGHT_AQUA_43 << "               ║" << endl;
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
    cout << "\t\t\t\t\t║ " << EMOJI_OCHO << " ║" << END_COLOR << TXT_BOLD <<" Mostrar inventario " << EMOJI_LLUVIA << TXT_LIGHT_AQUA_43 << "                  ║" << endl;
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
    cout << "\t\t\t\t\t║ " << EMOJI_NUEVE << " ║" << END_COLOR << TXT_BOLD <<" Mostrar objetivos " << EMOJI_LLUVIA << TXT_LIGHT_AQUA_43 << "                   ║" << endl;
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
    cout << "\t\t\t\t\t║ " << EMOJI_DIEZ << " ║" << END_COLOR << TXT_BOLD <<" Recolectar recursos producidos " << EMOJI_LLUVIA << TXT_LIGHT_AQUA_43 << "      ║" << endl;
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
    cout << "\t\t\t\t\t║ " << EMOJI_ONCE << " ║" << END_COLOR << TXT_BOLD <<" Moverse a una coordenada " << EMOJI_LLUVIA << TXT_LIGHT_AQUA_43 << "            ║" << endl;
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
    cout << "\t\t\t\t\t║ " << EMOJI_DOCE << " ║" << END_COLOR << TXT_BOLD <<" Finalizar turno " << EMOJI_LLUVIA << TXT_LIGHT_AQUA_43 << "                     ║" << endl;
    cout << "\t\t\t\t\t╠────╬───────────────────────────────────────╣" << endl;
...
void imprimir_objetos_mapa(){
    ...
    cout << TXT_LIGHT_PURPLE_104 << "║" << END_COLOR << "\t-Escuela ( " << EMOJI_ESCUELA << " )\t\t\t-Bomba ( " << EMOJI_METAL << " )" <<  TXT_LIGHT_PURPLE_104 << "\t    ║" << END_COLOR << endl;
    cout << TXT_LIGHT_PURPLE_104 << "■" << END_COLOR << "\t-Obelisco ( " << EMOJI_OBELISCO << " )\t\t-Andycoins ( " << EMOJI_METAL << " )" << TXT_LIGHT_PURPLE_104 << "    ■" << END_COLOR << endl;
